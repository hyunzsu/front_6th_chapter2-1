(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&a(t)}).observe(document,{childList:!0,subtree:!0});function l(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=l(n);fetch(n.href,i)}})();var r,V=0,m,u=0,H,L,y,C,p,A="p1",D="p2",R="p3",z="p4",K="p5";function Q(){var c,s,e,l,a,n,i,t,o,d;u=0,m=0,H=null,r=[{id:A,name:"버그 없애는 키보드",val:1e4,originalVal:1e4,q:50,onSale:!1,suggestSale:!1},{id:D,name:"생산성 폭발 마우스",val:2e4,originalVal:2e4,q:30,onSale:!1,suggestSale:!1},{id:R,name:"거북목 탈출 모니터암",val:3e4,originalVal:3e4,q:20,onSale:!1,suggestSale:!1},{id:z,name:"에러 방지 노트북 파우치",val:15e3,originalVal:15e3,q:0,onSale:!1,suggestSale:!1},{id:K,name:"코딩할 때 듣는 Lo-Fi 스피커",val:25e3,originalVal:25e3,q:10,onSale:!1,suggestSale:!1}];var c=document.getElementById("app");s=document.createElement("div"),s.className="mb-8",s.innerHTML=`
    <h1 class="text-xs font-medium tracking-extra-wide uppercase mb-2">🛒 Hanghae Online Store</h1>
    <div class="text-5xl tracking-tight leading-none">Shopping Cart</div>
    <p id="item-count" class="text-sm text-gray-500 font-normal mt-3">🛍️ 0 items in cart</p>
  `,y=document.createElement("select"),y.id="product-select",y.className="w-full p-3 border border-gray-300 rounded-lg text-base mb-3",e=document.createElement("div"),e.className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 flex-1 overflow-hidden",l=document.createElement("div"),l.className="bg-white border border-gray-200 p-8 overflow-y-auto",a=document.createElement("div"),a.className="mb-6 pb-6 border-b border-gray-200",C=document.createElement("button"),C.id="add-to-cart",C.innerHTML="Add to Cart",C.className="w-full py-3 bg-black text-white text-sm font-medium uppercase tracking-wider hover:bg-gray-800 transition-all",L=document.createElement("div"),L.id="stock-status",L.className="text-xs text-red-500 mt-3 whitespace-pre-line",a.appendChild(y),a.appendChild(C),a.appendChild(L),l.appendChild(a),p=document.createElement("div"),p.id="cart-items",l.appendChild(p),n=document.createElement("div"),n.className="bg-black text-white p-8 flex flex-col",n.innerHTML=`
  ...
  `,e.appendChild(l),e.appendChild(n),t.appendChild(o),c.appendChild(s),c.appendChild(e),c.appendChild(i),c.appendChild(t);for(var x=0,h=0;h<r.length;h++)x+=r[h].q;I(),N(),d=Math.random()*1e4,setTimeout(()=>{setInterval(function(){var g=Math.floor(Math.random()*r.length),v=r[g];v.q>0&&!v.onSale&&(v.val=Math.round(v.originalVal*80/100),v.onSale=!0,alert("⚡번개세일! "+v.name+"이(가) 20% 할인 중입니다!"),I(),F())},3e4)},d),setTimeout(function(){setInterval(function(){if(p.children.length,H){for(var g=null,v=0;v<r.length;v++)if(r[v].id!==H&&r[v].q>0&&!r[v].suggestSale){g=r[v];break}g&&(alert("💝 "+g.name+"은(는) 어떠세요? 지금 구매하시면 5% 추가 할인!"),g.val=Math.round(g.val*95/100),g.suggestSale=!0,I(),F())}},6e4)},Math.random()*2e4)}var G;function I(){var s,e,l;y.innerHTML="",s=0;for(var a=0;a<r.length;a++){var n=r[a];s=s+n.q}for(var i=0;i<r.length;i++)(function(){var t=r[i];e=document.createElement("option"),e.value=t.id,l="",t.onSale&&(l+=" ⚡SALE"),t.suggestSale&&(l+=" 💝추천"),t.q===0?(e.textContent=t.name+" - "+t.val+"원 (품절)"+l,e.disabled=!0,e.className="text-gray-400"):t.onSale&&t.suggestSale?(e.textContent="⚡💝"+t.name+" - "+t.originalVal+"원 → "+t.val+"원 (25% SUPER SALE!)",e.className="text-purple-600 font-bold"):t.onSale?(e.textContent="⚡"+t.name+" - "+t.originalVal+"원 → "+t.val+"원 (20% SALE!)",e.className="text-red-500 font-bold"):t.suggestSale?(e.textContent="💝"+t.name+" - "+t.originalVal+"원 → "+t.val+"원 (5% 추천할인!)",e.className="text-blue-500 font-bold"):e.textContent=t.name+" - "+t.val+"원"+l,y.appendChild(e)})();s<50?y.style.borderColor="orange":y.style.borderColor=""}function N(){var s,e,l,a,n,M,i,t,o,d,c,x,h,g,v;for(u=0,m=0,M=u,s=p.children,e=0,l=[],a=[],n=0;n<r.length;n++)r[n].q<5&&r[n].q>0&&a.push(r[n].name);for(let f=0;f<s.length;f++)(function(){for(var S,E=0;E<r.length;E++)if(r[E].id===s[f].id){S=r[E];break}var J=s[f].querySelector(".quantity-number"),q,O,b;q=parseInt(J.textContent),O=S.val*q,b=0,m+=q,e+=O;var Y=s[f],Z=Y.querySelectorAll(".text-lg, .text-xs");Z.forEach(function(j){j.classList.contains("text-lg")&&(j.style.fontWeight=q>=10?"bold":"normal")}),q>=10&&(S.id===A?b=10/100:S.id===D?b=15/100:S.id===R?b=20/100:S.id===z?b=5/100:S.id===K&&(b=25/100),b>0&&l.push({name:S.name,discount:b*100})),u+=O*(1-b)})();let w=0;var M=e;m>=30?(u=e*75/100,w=25/100):w=(e-u)/e;var U=new Date().getDay()===2,P=document.getElementById("tuesday-special");if(U&&u>0?(u=u*90/100,w=1-u/M,P.classList.remove("hidden")):P.classList.add("hidden"),document.getElementById("item-count").textContent="🛍️ "+m+" items in cart",t=document.getElementById("summary-details"),t.innerHTML="",e>0){for(let f=0;f<s.length;f++){for(var B,T=0;T<r.length;T++)if(r[T].id===s[f].id){B=r[T];break}var W=s[f].querySelector(".quantity-number"),_=parseInt(W.textContent),X=B.val*_;t.innerHTML+=`
    ...
    `}o=G.querySelector(".text-2xl"),o&&(o.textContent="₩"+Math.round(u).toLocaleString()),d=document.getElementById("loyalty-points"),d&&(c=Math.floor(u/1e3),c>0?(d.textContent="적립 포인트: "+c+"p",d.style.display="block"):(d.textContent="적립 포인트: 0p",d.style.display="block")),x=document.getElementById("discount-info"),x.innerHTML="",w>0&&u>0&&(i=M-u,x.innerHTML=`
...
`)}),L.textContent=s};function F(){for(var s=0,e=0,l;p.children[e];){var a=p.children[e].querySelector(".quantity-number");s+=a?parseInt(a.textContent):0,e++}for(s=0,e=0;e<p.children.length;e++)s+=parseInt(p.children[e].querySelector(".quantity-number").textContent);l=p.children;for(var n=0;n<l.length;n++){for(var i=l[n].id,t=null,o=0;o<r.length;o++)if(r[o].id===i){t=r[o];break}if(t){var d=l[n].querySelector(".text-lg"),c=l[n].querySelector("h3");t.onSale&&t.suggestSale?(d.innerHTML='<span class="line-through text-gray-400">₩'+t.originalVal.toLocaleString()+'</span> <span class="text-purple-600">₩'+t.val.toLocaleString()+"</span>",c.textContent="⚡💝"+t.name):t.onSale?(d.innerHTML='<span class="line-through text-gray-400">₩'+t.originalVal.toLocaleString()+'</span> <span class="text-red-500">₩'+t.val.toLocaleString()+"</span>",c.textContent="⚡"+t.name):t.suggestSale?(d.innerHTML='<span class="line-through text-gray-400">₩'+t.originalVal.toLocaleString()+'</span> <span class="text-blue-500">₩'+t.val.toLocaleString()+"</span>",c.textContent="💝"+t.name):(d.textContent="₩"+t.val.toLocaleString(),c.textContent=t.name)}}N()}Q();C.addEventListener("click",function(){for(var s=y.value,e=!1,l=0;l<r.length;l++)if(r[l].id===s){e=!0;break}if(!(!s||!e)){for(var a=null,n=0;n<r.length;n++)if(r[n].id===s){a=r[n];break}if(a&&a.q>0){var i=document.getElementById(a.id);if(i){var t=i.querySelector(".quantity-number"),o=parseInt(t.textContent)+1;o<=a.q+parseInt(t.textContent)?(t.textContent=o,a.q--):alert("재고가 부족합니다.")}else{var d=document.createElement("div");d.id=a.id,d.className="grid grid-cols-[80px_1fr_auto] gap-5 py-5 border-b border-gray-100 first:pt-0 last:border-b-0 last:pb-0",d.innerHTML=`
      ...
      `,p.appendChild(d),a.q--}N(),H=s}}});p.addEventListener("click",function(s){var e=s.target;if(e.classList.contains("quantity-change")||e.classList.contains("remove-item")){for(var l=e.dataset.productId,a=document.getElementById(l),n=null,i=0;i<r.length;i++)if(r[i].id===l){n=r[i];break}if(e.classList.contains("quantity-change")){var t=parseInt(e.dataset.change),o=a.querySelector(".quantity-number"),d=parseInt(o.textContent),c=d+t;c>0&&c<=n.q+d?(o.textContent=c,n.q-=t):c<=0?(n.q+=d,a.remove()):alert("재고가 부족합니다.")}else if(e.classList.contains("remove-item")){var o=a.querySelector(".quantity-number"),x=parseInt(o.textContent);n.q+=x,a.remove()}n&&n.q<5,N(),I()}});
